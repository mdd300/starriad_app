                                    ...
                                    empresas.produtos.map(produtos => (
                                        ...
                                        <View style={{width: '100%', justifyContent: 'center', alignItems: 'center'}} key={produtos.id}>
                                            ...
                                            <ScrollView pagingEnabled={true} horizontal={true} showsHorizontalScrollIndicator={false} style={{flex: 1, width: '100%', flexDirection: 'row'}}>
                                                <View style={{height: 500, width: this.state.deviceWidth, backgroundColor: '#f3f3f3'}}>
                                            ...
                                            <View style={{width: '100%', maxWidth: 500, marginTop: 20,  justifyContent: 'center', alignItems: 'center'}}>
                                                <Text style={{fontSize: 25, color: '#484848', marginBottom: 15}} >
                                                    {produtos.descricao}
                                                </Text>

                                                <Text style={{fontSize: 18, color: '#767e8a', marginBottom: 15}} >
                                                    {produtos.codigo}
                                                </Text>
                                                ...
                                                <View style={{flex: 1, flexDirection: 'row', marginBottom: 15}}>
                                                    <Text style={{fontSize: 18, color: '#484848'}} >
                                                        Cor:
                                                    </Text>

                                                    <Text style={{fontSize: 18, color: '#767e8a', marginLeft: 5}} >
                                                        {produtos.cor}
                                                    </Text>
                                                </View>

                                                <View style={{width: '100%', justifyContent: 'center', alignItems: 'center', padding: 10}}>
                                                    <ScrollView style={{height: 62, width: '100%', flexDirection: 'row'}} horizontal={true} showsHorizontalScrollIndicator={false}>
                                                        {produtos.variantes.map(variantes => (
                                                            <TouchableOpacity key={variantes.id} style={{justifyContent: 'center', alignItems: 'center', width: 60, height: 60, borderRadius: 50, marginRight: 15, borderWidth: 1, borderColor: '#c2c2c2'}}>
                                                                <Text style={{width: '95%', height: '95%', backgroundColor: variantes.cor, borderRadius: 50, borderWidth: 1, borderColor: '#c2c2c2'}} />
                                                            </TouchableOpacity>
                                                        ))}
                                                    </ScrollView>
                                                </View>
