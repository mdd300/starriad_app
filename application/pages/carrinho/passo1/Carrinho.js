...
import CarrinhoService from '../../../services/carrinho/carrinho-services';
...
export default class Carrinho extends React.Component {
    ...
    getCarrinho = async ()=>{
        ...
        CarrinhoService.getCarrinho(restkey).then((result)=>{
            this.setState({pedido: result.data});
            this.setState({loading: false});
            console.log(<result className="data empresas"></result>)
        }).catch((e)=> {
            console.log(e)
        });
    }
